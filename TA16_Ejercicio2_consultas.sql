...
/* 2.6 Obtener todos los datos de los empleados que trabajan para el departamento 37
y para el departamento 77 */
SELECT * FROM empleados
...
SELECT COUNT(*) AS 'Empleados', DEPARTAMENTO FROM empleados
...
/* 2.11 Obtener un listado completo de empleados, incluyendo el nombre y apellidos del empleado junto al nombre y el 
...
SELECT e.NOMBRE, APELLIDOS FROM empleados e
JOIN departamentos ON e.DEPARTAMENTO = departamentos.CODIGO
...
JOIN empleados ON D.CODIGO=empleados.DEPARTAMENTO
GROUP BY DEPARTAMENTO
HAVING COUNT(DNI) >2;

/* 2.15 Añadir un nuevo departamento: 'Calidad', con presupuesto de 40.000€ y código 11. Añadir un empleado vinculado
al departamento recién creado: Esther Vázquez, DNI: 89267109 */
...
UPDATE empleados
SET DEPARTAMENTO = 14 WHERE DEPARTAMENTO = 77;
